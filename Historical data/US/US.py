...
urls = [
    f"https://stats.bis.org/api/v2/data/dataflow/BIS/WS_CBPOL/1.0/M.US?startPeriod=2021-01-01&endPeriod=2026-01-01&format=csv"
]
...
for i in range(0, len(old_gdp)):
    new_gdp[3 * i], new_gdp[3 * i + 1], new_gdp[3 * i + 2] = (
        old_gdp[i],
        old_gdp[i],
        old_gdp[i],
    )

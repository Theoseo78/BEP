...
def create_historical(region):
    ...
    for file_name, vname in regional_files[region].items():
        ...
        # Code below is considered faulty due to misinterpretation of the NGFS scenarios
        # Economic paths generated by the HMM is considered the baseline scenario
        # The data presented by the NGFS scenarios are deviations from the paths
